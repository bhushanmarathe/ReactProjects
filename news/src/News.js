...
export class News extends Component {
    ...
    handleNextClick = async () => {
     ...
     fetchMoreData = async () => {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=a18a20cf126e4b33baf8147e3c747a64&page=${nextPage}&pageSize=${this.props.pageSize}`;
                            ...
                            {this.state.articles.map((element) => {
                                return <div className="col-md-4" key={element.url}>
                                    <NewsItem
                                        ...
                                        newsUrl={element.url ? element.url : "#"} author={element.author} date={element.publishedAt} source={element.source.name} category={this.props.category}
                                    />
                                </div>
